...
Link to the share RStudio Cloud project that created this report: https://rstudio.cloud/spaces/115177/project/2210076
...
Our analysis plan is dependent on determining correlations between multiple important and controllable factors in the training process. We will do this by using data analysis tools such as graphs and linear regression to determine whether one factor of the training process impacts performance and if so, what the impact of that factor is. Our analysis depends on several factors.
