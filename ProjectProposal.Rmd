...
With the data given and additional data on monthly air traffic, weather and seasons, the following questions will be adressed by our analysis: `Ideally we'll end up with 3 questions so some may be cut or combined to give more concrete analysis`
  ...
  - How can students succeed the quickest?
...
To help determine when air traffic is the lowest, and thus flight accident risk is the lowest, we acquired air traffic data from `Insert source where air traffic data came from here`.
