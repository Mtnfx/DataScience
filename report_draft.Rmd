...
This data was used to compare the weather conditions that training sessions are currently being held in to possible ideal conditions.\
We will utilise information in the following variables: Year, Month, Day, SPEED_MAX_GUST \
...
Air traffic data was also used to try to determine a relation between the time of year and the density of air traffic. To help determine when air traffic is the lowest, and thus flight accident risk is the lowest, we acquired air traffic data from the suggested supplementary data.\
