...
`Note that the variable Time In School is equal to the difference between the first and last session a student completed` We observed that only Student# 88 completed all the requirements for the pilot's license, however multiple students have come very close to completion.
